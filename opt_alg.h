...
solution lag(matrix(*ff)(matrix, matrix, matrix), double a, double b, double c, double epsilon, double gamma, int Nmax, matrix ud1 = NAN, matrix ud2 = NAN); // throw (string);
